            ...
            <div class="card card-success">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <button onclick="remover34()"  type="button" class="btn btn-tool" data-card-widget="remove">
...
<script type="text/javascript">
 ...
 $.unblockUI();
    ...
    $.ajax({
          ...
          url:'modulos/herramientas/secciones_notas_materias/elementos/seccion_curso.php',
          success:function(r){

            $('#contenidoAyuda').html('');
           
            $('#contenidoAyuda').load('modulos/herramientas/secciones_notas_materias/secciones_materias_notas.php');
