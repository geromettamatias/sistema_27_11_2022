            ...
            <div class="card card-danger">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <button onclick="remover_dos()"  type="button" class="btn btn-tool" data-card-widget="remove">
    ...
    $("#cicloLectivoFina").change(function(){
      ...
      if (cicloLectivoFina=='Seleccione un año lectivo') {
       ...
       $.ajax({
          ...
          url:'modulos/gestionAcademicaAlumno/visualizacion_Mesa/elementos/seccionCiclo.php',
          success:function(r){
